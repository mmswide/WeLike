...
import com.planet1107.welike.adapters.FollowersAdapter;
import com.planet1107.welike.connect.User;
import com.planet1107.welike.loaders.FollowersLoader;
...
public class FollowersActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<User>>, OnRefreshListener, OnScrollListener {
	...
	FollowersLoader mFollowersLoader;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mFollowersAdapter = new FollowersAdapter(this);
    ...
    public Loader<List<User>> onCreateLoader(int id, Bundle args) {
		...
		mFollowersLoader = new FollowersLoader(this, mUserID);
