...
public class FollowersLoader extends AsyncTaskLoader<List<User>> {
    ...
    public FollowersLoader(Context context, int userID) {
    ...
    public List<User> loadInBackground() {
    	...
    	int page = mFollowers != null ? (mFollowers.size() / 7 + 1) : 1;
    	ArrayList<User> likes = sharedConnect.getFollowers(mUserID, page, 7);
        return likes;
    }
