...
public class CommentsLoader extends AsyncTaskLoader<List<Comment>> {
    ...
    public List<Comment> loadInBackground() {
    	...
    	int page = mComments != null ? (mComments.size() / 7 + 1) : 1;
    	ArrayList<Comment> comments = sharedConnect.getComments(mPostID, page, 7);
        return comments;
    }
    ...
    public void deliverResult(List<Comment> comments) {
        ...
        mLoadMore = comments != null ? comments.size() == 7 : false;
        if (isStarted()) {
